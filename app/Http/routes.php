...
Route::get('/logowanie/{social_provider}', ['as' => 'auth.login.social.redirect', 'uses' => 'Auth\AuthController@redirectToProvider'])
    ->where('social_provider', 'bitbucket|facebook');
Route::get('/logowanie/{social_provider}/redirect', ['as' => 'auth.login.social', 'uses' => 'Auth\AuthController@handleProviderCallback'])
    ->where('social_provider', 'bitbucket|facebook');
